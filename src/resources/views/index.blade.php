...
<section class="hero-area">
    <div class="hero-post-slides owl-carousel">
        ...
        <div class="single-hero-post">
            <!-- Post Image -->
            <div class="slide-img bg-img" style="background-image: url(../../public/img/blog-img/2.jpg);"></div>
            <!-- Post Content -->
        ...
        <div class="single-hero-post">
            <!-- Post Image -->
            <div class="slide-img bg-img" style="background-image: url(../../public/img/blog-img/3.jpg);"></div>
            <!-- Post Content -->
            <div class="hero-slides-content">
        ...
        <div class="single-hero-post">
            <!-- Post Image -->
            <div class="slide-img bg-img" style="background-image: url(../../public/img/blog-img/4.jpg);"></div>
            <!-- Post Content -->
            <div class="hero-slides-content">
        ...
        <div class="single-hero-post">
            <!-- Post Image -->
            <div class="slide-img bg-img" style="background-image: url(../../public/img/blog-img/5.jpg);"></div>
            <!-- Post Content -->
            <div class="hero-slides-content">
        ...
        <div class="single-hero-post">
            <!-- Post Image -->
            <div class="slide-img bg-img" style="background-image: url(../../public/img/blog-img/6.jpg);"></div>
            <!-- Post Content -->
            <div class="hero-slides-content">
                <p>MAY 8, 2018 / foody</p>
                <a href="#" class="post-title">
                ...
                <div class="featured-post-area">
                    <div id="featured-post-slides" class="carousel slide d-flex flex-wrap" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            <div class="carousel-item active bg-img" style="background-image: url(../../public/img/blog-img/7.jpg)">
                            ...
                            <div class="carousel-item bg-img" style="background-image: url(../../public/img/blog-img/6.jpg)">
                                <!-- Featured Post Content -->
                                <div class="featured-post-content">
                                    <p>MAY 8, 2018 / foody</p>
                                    <a href="#" class="post-title">
                            ...
                            <div class="carousel-item bg-img" style="background-image: url(../../public/img/blog-img/2.jpg)">
                                <!-- Featured Post Content -->
                                <div class="featured-post-content">
                                    <p>MAY 8, 2018 / foody</p>
                                    <a href="#" class="post-title">
                            ...
                            <div class="carousel-item bg-img" style="background-image: url(../../public/img/blog-img/3.jpg)">
                                <!-- Featured Post Content -->
                                <div class="featured-post-content">
                                    <p>MAY 8, 2018 / foody</p>
                                    <a href="#" class="post-title">
                            ...
                            <div class="carousel-item bg-img" style="background-image: url(../../public/img/blog-img/5.jpg)">
                                <!-- Featured Post Content -->
                                <div class="featured-post-content">
                                    <p>MAY 8, 2018 / foody</p>
                                    <a href="#" class="post-title">
